...
/**
 * 配置可信工作区与默认 Explorer；Terminal 不在启动布局里。
 * Configures the trusted workspace and default Explorer. Terminal is not in
 * the startup layout so remount does not start isolate Bash.
 */
